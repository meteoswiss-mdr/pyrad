...
def main():
    ...
    time_dir_list = [
        ...
        '2017-07-19', '2017-07-30', '2017-08-01']
    ...
    for trt_fname in trt_list:
        ...
        (traj_ID, yyyymmddHHMM, lon_trt, lat_trt, ell_L, ell_S, ell_or, area,
...
#            labely='Flash dens [Flashes/Km2]', labels=['Flash density'], title=titl,
...
#        figfname = plot_timeseries(
#            yyyymmddHHMM, [nflashes/area], [figfname], labelx='Time [UTC]',
#            labely='Source dens [Sources/Km2]', labels=['Source density'], title=titl,
#            period=0, timeformat=None, colors=None, linestyles=None,
#            markers=None, ymin=None, ymax=None, dpi=72)
#        print('Plotted '+' '.join(figfname))
#
