...
MY_POLARNAMES = {
    ...
    'Phidp' : ['uncorrected_differential_phase','Differential phase', 'deg',0., 150.,1.],
    'Rhohv' : ['uncorrected_cross_correlation_ratio','Copolar correlation coefficient', '-',0.57, 1., 0.05],
    'ZhCorr' : ['corrected_unfiltered_reflectivity','Attenuation corrected reflectivity', 'dBZ', 0., 55.,1.], 
    'ZdrCorr' : ['corrected_differential_reflectivity','Attenuation corrected differential reflectivity','dB', 0., 3., 0.1],
