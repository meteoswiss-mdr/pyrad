...
# 2016.05.10 fvj tested. We need the cylp module to test this function

import numpy as np
import matplotlib.pyplot as plt
import pyart

datapath='/data/pyart_examples/'
filename='110635.mdv'

# perform LP phase processing (this takes a while)
radar = pyart.io.read_mdv(datapath+filename)
...
phidp, kdp = pyart.correct.phase_proc_lp(radar, 0.0, LP_solver='cvxopt', debug=True) #added LP_solver variable to specify the kind of solver
