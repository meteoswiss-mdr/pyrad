...
def moist_ascent(startp, startt, ptop=10, nsteps=501):
    ...
    for ii in range(preswet.shape[0]-1):
        ...
        temp = temp + 100 * delp * GammaW(
            temp+degCtoK, (preswet[ii]-delp/2)*100)
        tempwet[ii+1] = temp
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 1 or sys.argv[1] == "example1":
        ...
        examples = ('94610.2010032200', '94610.2010032200',
                    '94610.2010032200',)
        ...
        examples = ('94578.2008111612', '94610.2010032200',
                    '94866.2010030600',)
        parcels = ((1014., 23., 19., 'user'), (1014., 25, 18, 'user'),
                   (1000, 21, 16, 'user'))
