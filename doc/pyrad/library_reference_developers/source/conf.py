...
project = 'pyrad'
copyright = '2016, meteoswiss-mdr'
author = 'meteoswiss-mdr'
...
latex_documents = [
    (master_doc, 'pyrad_library_reference_dev.tex', 'pyrad library reference for developers',
...
man_pages = [
    (master_doc, 'pyrad', 'pyrad Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyrad', 'pyrad library reference for developers',
